...
public:
    my_CNN(Tensorholder<float> *x, Tensorholder<float> *label) {
...
#endif  // __CUDNN
        // ======================= layer 1=======================
        out = AddOperator(new ConvolutionLayer2D<float>(out, 1, 32, 3, 3, 1, 1, 0, TRUE, "1"));
#if __CUDNN__
        ...
        // ======================= layer 2=======================
        out = AddOperator(new ConvolutionLayer2D<float>(out, 32, 64, 3, 3, 1, 1, 0, TRUE, "2"));
#if __CUDNN__
        ...
        // ======================= layer 3=======================
        out = AddOperator(new Linear<float>(out, 5 * 5 * 64, 10, TRUE, "3"));
