...
void IMAGE_Reader(string pImagePath, DTYPE** pImage)
{
    ifstream fin;
...
template <typename DTYPE>
void MNISTDataSet<DTYPE>::Alloc(string pImagePath, string pLabelPath)
{
...
template <typename DTYPE>
void MNISTDataSet<DTYPE>::Delete()
{
    if (m_aaImage)
    {
...
template <typename DTYPE>
std::vector<Tensor<DTYPE>*>* MNISTDataSet<DTYPE>::GetData(int idx)
{
...
template <typename DTYPE>
int MNISTDataSet<DTYPE>::GetLength()
{
    if (m_option == TRAINING)
    {
