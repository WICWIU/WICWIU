...
template<typename DTYPE> void LFWDataset<DTYPE>::Alloc()  {}

template<typename DTYPE> void LFWDataset<DTYPE>::Delete() {}
...
template<typename DTYPE> int LFWDataset<DTYPE>::GetLength() {
    return m_numOfImage;
}
