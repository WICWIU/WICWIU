...
public:
    my_FaceNet(Tensorholder<float>* x, Tensorholder<float>* label, int pNumOfClass)
    {
        ...
        // ======================= Layer 6========================
        out = new ConvolutionLayer2D<float>(out, 256, 256, 1, 1, 1, 1, 0, TRUE, "Conv_6");
        out = new ConvolutionLayer2D<float>(out, 256, 256, 3, 3, 1, 1, 1, TRUE, "Conv_6-a");
        ...
        out = new Linear<float>(out, 1 * 32 * 128, 1 * 32 * 128, TRUE, "Fully-Connected_2");

        out = new Linear<float>(out, 1 * 32 * 128, 1 * 1 * 128, TRUE, "Fully-Connected_3");
