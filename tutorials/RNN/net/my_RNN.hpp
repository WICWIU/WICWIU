...
private:
public:
    my_RNN(Tensorholder<float> *x, Tensorholder<float> *label, int vocabLength, int embeddingDim, int hiddenSize) {
        SetInput(2, x, label);
        ...
        // ======================= layer 1=======================
        out = new RecurrentLayer<float>(out, embeddingDim, hiddenSize, NULL, TRUE, "Recur_1");
