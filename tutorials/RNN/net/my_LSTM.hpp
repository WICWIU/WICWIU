...
class my_LSTM : public NeuralNetwork<float>{
private:
public:
    my_LSTM(Tensorholder<float> *x, Tensorholder<float> *label, int vocabLength, int embeddingDim, int hiddenSize) {
        SetInput(2, x, label);
        ...
        // ======================= layer 1=======================
        out = new LSTMLayer<float>(out, embeddingDim, hiddenSize, NULL, TRUE, "Recur_1");
