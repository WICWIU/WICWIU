...
int main(int argc, char const* argv[])
{
    Tensorholder<float>* input0 =
        new Tensorholder<float>(Tensor<float>::Random_normal(1, 1, 1, 2, 2, 0.0, 0.1), "x");
    Tensorholder<float>* input1 =
        new Tensorholder<float>(Tensor<float>::Random_normal(1, 1, 3, 2, 2, 0.0, 0.1), "label");
