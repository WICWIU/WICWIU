...
class LRelu : public Operator<DTYPE>
{
private:
...
public:
    ...
    */
    LRelu(Operator<DTYPE>* pInput, float negativeSlope, int pLoadflag = TRUE)
        : Operator<DTYPE>(pInput, "NO NAME", pLoadflag)
    {
#ifdef __DEBUG__
    ...
    @ref int Alloc(Operator<DTYPE> *pInput, float negativeSlope)
    */
    LRelu(Operator<DTYPE>* pInput, float negativeSlope, std::string pName, int pLoadflag = TRUE)
