#ifndef WGANDISCRIMINATORLOSS_H_
#define WGANDISCRIMINATORLOSS_H_ value

#include "../LossFunction.hpp"

template <typename DTYPE>
class WGANDiscriminatorLoss : public LossFunction<DTYPE>
{
public:
    WGANDiscriminatorLoss(Operator<DTYPE>* pOperator, Operator<DTYPE>* pLabel, std::string pName)
        : LossFunction<DTYPE>(pOperator, pLabel, pName)
    {
#ifdef __DEBUG__
        std::cout << "WGANDiscriminatorLoss::WGANDiscriminatorLoss(Operator<DTYPE> *, "
