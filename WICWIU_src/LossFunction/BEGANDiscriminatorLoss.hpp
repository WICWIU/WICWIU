...
{
public:
    BEGANDiscriminatorLoss(Operator<DTYPE>* pOperator, Operator<DTYPE>* pLabel, std::string pName)
        : LossFunction<DTYPE>(pOperator, pLabel, pName)
    {
#ifdef __DEBUG__
        std::cout << "BEGANDiscriminatorLoss::BEGANDiscriminatorLoss(Operator<DTYPE> *, "
