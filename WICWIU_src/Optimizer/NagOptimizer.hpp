...
class NagOptimizer : public Optimizer<DTYPE>
{
private:
...
public:
    ...
    */
    NagOptimizer(Container<Operator<DTYPE>*>* pParameterContainer, float pLearningRate,
    ...
    */
    NagOptimizer(Container<Operator<DTYPE>*>* pParameterContainer, float pLearningRate,
                 float momentum, float weightDecayRate, OptimizeDirection pOptimizeDirection)
    ...
    */
    int UpdateParameter(Operator<DTYPE>* pParameter, Tensor<DTYPE>* pVelocity)
    {
        ...
        for (int i = 0; i < capacity; i++)
        {
            ...
            (*trainable_data)[i] +=
                -m_momentum * (*prev_Velocity)[i] + ((1.f + m_momentum) * (*pVelocity)[i]);
        }
