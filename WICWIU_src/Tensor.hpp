...
@details Operator클래스에서 m_aaResult(ForwardPropagate한 값)와 m_aaGradient(BackPropagate한 값)을
저장한다.
*/
...
public:
    Tensor(int pSize0, int pSize1, int pSize2, int pSize3, int pSize4,
           IsUseTime pAnswer = UseTime); // For 5D-Tensor
    Tensor(int pSize0, int pSize1, int pSize2, int pSize3,
           IsUseTime pAnswer = UseTime);                                     // For 4D-Tensor
    ...
    static Tensor<DTYPE>* Random_normal(int pSize0, int pSize1, int pSize2, int pSize3, int pSize4,
                                        float mean, float stddev, IsUseTime pAnswer = UseTime);
    static Tensor<DTYPE>* Random_normal(Shape* pShape, float mean, float stddev,
                                        IsUseTime pAnswer = UseTime);
    static Tensor<DTYPE>* Truncated_normal(int pSize0, int pSize1, int pSize2, int pSize3,
                                           int pSize4, float mean, float stddev, float trunc,
                                           IsUseTime pAnswer = UseTime);
    static Tensor<DTYPE>* Truncated_normal(Shape* pShape, float mean, float stddev, float trunc,
                                           IsUseTime pAnswer = UseTime);
    static Tensor<DTYPE>* Random_Uniform(int pSize0, int pSize1, int pSize2, int pSize3, int pSize4,
                                         float LowerLimit, float UpperLimit,
                                         IsUseTime pAnswer = UseTime);
    static Tensor<DTYPE>* Random_Uniform(Shape* pShape, float LowerLimit, float UpperLimit,
                                         IsUseTime pAnswer = UseTime);
    ...
    static Tensor<DTYPE>* Constants(int pSize0, int pSize1, int pSize2, int pSize3, int pSize4,
                                    DTYPE constant, IsUseTime pAnswer = UseTime);
...
*/
template <typename DTYPE>
int Tensor<DTYPE>::Alloc(Shape* pShape, IsUseTime pAnswer)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
int Tensor<DTYPE>::Alloc(Tensor<DTYPE>* pTensor)
{
#ifdef __DEBUG__
...
/*!
 *@brief 5D-Tensor 생성자.
 *@details 원하는 형태의 Shape정보(Time, Batch, Channel, Row, Column들의 Dimension)를 받아 Tensor를
 *Alloc하는 생성자.
 ...
 */
template <typename DTYPE>
Tensor<DTYPE>::Tensor(int pSize0, int pSize1, int pSize2, int pSize3, int pSize4, IsUseTime pAnswer)
{
#ifdef __DEBUG__
    std::cout << "Tensor<DTYPE>::Tensor(int pSize0, int pSize1, int pSize2, int pSize3, int "
                 "pSize4, IsUseTime pAnswer)"
              << '\n';
#endif // __DEBUG__
...
/*!
*@brief 4D-Tensor 생성자.
*@details 원하는 형태의 Shape정보(Batch, Channel, Row, Column들의 Dimension)를 받아 Tensor를
Alloc하는 생성자.
...
*/
template <typename DTYPE>
Tensor<DTYPE>::Tensor(int pSize0, int pSize1, int pSize2, int pSize3, IsUseTime pAnswer)
{
#ifdef __DEBUG__
    std::cout << "Tensor<DTYPE>::Tensor(int pSize0, int pSize1, int pSize2, int pSize3, IsUseTime "
                 "pAnswer)"
              << '\n';
#endif // __DEBUG__
...
/*!
 *@brief 3D-Tensor 생성자.
 *@details 원하는 형태의 Shape정보(Channel, Row, Column들의 Dimension)를 받아 Tensor를 Alloc하는
 *생성자.
 ...
 */
template <typename DTYPE>
Tensor<DTYPE>::Tensor(int pSize0, int pSize1, int pSize2, IsUseTime pAnswer)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
Tensor<DTYPE>::Tensor(int pSize0, int pSize1, IsUseTime pAnswer)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
Tensor<DTYPE>::Tensor(int pSize0, IsUseTime pAnswer)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
Tensor<DTYPE>::Tensor(Shape* pShape, IsUseTime pAnswer)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
Tensor<DTYPE>::Tensor(Tensor* pTensor)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
int Tensor<DTYPE>::GetDim(int pRanknum)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
LongArray<DTYPE>* Tensor<DTYPE>::GetLongArray()
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
int Tensor<DTYPE>::GetElement(unsigned int index)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
DTYPE& Tensor<DTYPE>::operator[](unsigned int index)
{
#ifdef __CUDNN__
#if __DEBUG__
 ...
 */
template <typename DTYPE>
IsUseTime Tensor<DTYPE>::GetIsUseTime()
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
DTYPE* Tensor<DTYPE>::GetCPULongArray(unsigned int pTime)
{
#ifdef __CUDNN__
#if __DEBUG__
 ...
 *@details Tensor가 time 축을 사용하는 경우, Tensor의 time의 rank 값을 반환한다 @ref
 *Shape::GetRank()
 *@return 값이 존재할 시 Tensor의 time의 rank, 존재하지 않을 시 0
 */
template <typename DTYPE>
int Tensor<DTYPE>::GetTimeSize()
{
#ifdef __DEBUG__
    std::cout << "Tensor<DTYPE>::GetTimeSize()" << '\n';
#endif // __DEBUG__

    if ((m_aShape->GetRank() == 5) && (m_IsUseTime == UseTime))
        return (*m_aShape)[0];
    else
        return 0;
}
...
template <typename DTYPE>
int Tensor<DTYPE>::GetChannelSize()
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
int Tensor<DTYPE>::ReShape(int pSize0, int pSize1, int pSize2, int pSize3, int pSize4)
{
#ifdef __DEBUG__
    std::cout
        << "Tensor<DTYPE>::ReShape(int pSize0, int pSize1, int pSize2, int pSize3, int pSize4)"
        << '\n';
#endif // __DEBUG__
 ...
 */
template <typename DTYPE>
int Tensor<DTYPE>::ReShape(int pSize0, int pSize1, int pSize2, int pSize3)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
int Tensor<DTYPE>::ReShape(int pSize0, int pSize1, int pSize2)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
int Tensor<DTYPE>::ReShape(int pSize0, int pSize1)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
int Tensor<DTYPE>::ReShape(int pSize0)
{
#ifdef __DEBUG__
 ...
 */
template <typename DTYPE>
void Tensor<DTYPE>::SetDeviceCPU()
{
#ifdef __DEBUG__
 ...
 *@details 장치를 CPU로 전환하고 m_aLongArray의 Save(fileForsave) 메소드 호출 @ref
 *LongArray<DTYPE>::Save(FILE *fileForSave)
 *@param fileForSave 불러오기 할 FILE에 대한 포인터
 *@return 성공 시 TRUE
 *@see LongArray<DTYPE>::Save(FILE *fileForSave), Tensor<DTYPE>::SetDeviceCPU()
 */
template <typename DTYPE>
int Tensor<DTYPE>::Save(FILE* fp)
{
#ifdef __CUDNN__
#if __DEBUG__
 ...
 *@details 장치를 CPU로 전환하고 m_aLongArray의 Load(fileForsave) 메소드 호출 @ref
 *LongArray<DTYPE>::Load(FILE *fileForSave)
 *@param fileForload 불러오기 할 FILE에 대한 포인터
 *@return 성공 시 TRUE
 *@see LongArray<DTYPE>::Load(FILE *fileForSave), Tensor<DTYPE>::SetDeviceCPU()
 */
template <typename DTYPE>
int Tensor<DTYPE>::Load(FILE* fp)
{
#ifdef __CUDNN__
#if __DEBUG__
...
template <typename DTYPE>
void Tensor<DTYPE>::Clip(float min, float max)
{
#ifdef __DEBUG__
    ...
    for (int ba = 0; ba < batchsize; ba++)
    {
        for (int ch = 0; ch < channelsize; ch++)
        {
            for (int ro = 0; ro < rowsize; ro++)
            {
                ...
                {
                    index = (((ti * (*resultTenShape)[1] + ba) * (*resultTenShape)[2] + ch) *
                                 (*resultTenShape)[3] +
                             ro) *
                                (*resultTenShape)[4] +
                            co;
...
template <typename DTYPE>
void Tensor<DTYPE>::MultiplyScalar(unsigned int pTime, float pScalar)
{
    int batchsize = this->GetBatchSize();
    int channelsize = this->GetChannelSize();
    int rowsize = this->GetRowSize();
...
#ifdef __CUDNN__
template <typename DTYPE>
void Tensor<DTYPE>::SetDeviceGPU(unsigned int idOfDevice)
{
#if __DEBUG__
...
template <typename DTYPE>
DTYPE* Tensor<DTYPE>::GetGPUData(unsigned int pTime)
{
#if __DEBUG__
...
template <typename DTYPE>
cudnnTensorDescriptor_t& Tensor<DTYPE>::GetDescriptor()
{
#if __DEBUG__
...
template <typename DTYPE>
void Tensor<DTYPE>::Reset(cudnnHandle_t& pCudnnHandle)
{
#if __DEBUG__
    ...
    for (int i = 0; i < pTime; i++)
    {
        ...
        checkCUDNN(
            cudnnAddTensor(pCudnnHandle, &zero, pDesc, pDevLongArray, &zero, pDesc, pDevLongArray));
    }
}
 ...
 *@details pSize 0~4를 매개변수로 받는 Shape를 생성하고, mean을 평균으로 stddev를 표준편차로 갖는
 *정규분포에서 임의로 얻어진 값으로 초기화된 LongArray<DTYPE>를 갖는 텐서를 생성한다.
 ...
 *@see Tensor<DTYPE>::Random_normal(Shape * pShape, float mean, float stddev, IsUseTime pAnswer =
 *UseTime)
 */
template <typename DTYPE>
Tensor<DTYPE>* Tensor<DTYPE>::Random_normal(int pSize0, int pSize1, int pSize2, int pSize3,
                                            int pSize4, float mean, float stddev, IsUseTime pAnswer)
{
#ifdef __DEBUG__
    std::cout << "Tensor<DTYPE>::Random_normal()" << '\n';
#endif // __DEBUG__

    return Tensor<DTYPE>::Random_normal(new Shape(pSize0, pSize1, pSize2, pSize3, pSize4), mean,
                                        stddev, pAnswer);
}

/*!
 *@brief 정규분포를 따르는 임의의 값을 갖는 Tensor를 생성
 *@details pShape를 Shape로 갖고, mean을 평균으로 stddev를 표준편차로 갖는 정규분포에서 임의로
 *얻어진 값으로 초기화된 LongArray<DTYPE>를 갖는 텐서를 생성한다.
 ...
 */
template <typename DTYPE>
Tensor<DTYPE>* Tensor<DTYPE>::Random_normal(Shape* pShape, float mean, float stddev,
                                            IsUseTime pAnswer)
{
#ifdef __DEBUG__
    std::cout << "Tensor<DTYPE>::Random_normal()" << '\n';
...
template <typename DTYPE>
Tensor<DTYPE>* Tensor<DTYPE>::Truncated_normal(int pSize0, int pSize1, int pSize2, int pSize3,
                                               int pSize4, float mean, float stddev, float trunc,
                                               IsUseTime pAnswer)
{
#ifdef __DEBUG__
    ...
    return Tensor<DTYPE>::Truncated_normal(new Shape(pSize0, pSize1, pSize2, pSize3, pSize4), mean,
                                           stddev, trunc, pAnswer);
}

template <typename DTYPE>
Tensor<DTYPE>* Tensor<DTYPE>::Truncated_normal(Shape* pShape, float mean, float stddev, float trunc,
                                               IsUseTime pAnswer)
{
#ifdef __DEBUG__
    std::cout << "Tensor<DTYPE>::Truncated_norma" << '\n';
...
template <typename DTYPE>
Tensor<DTYPE>* Tensor<DTYPE>::Random_Uniform(int pSize0, int pSize1, int pSize2, int pSize3,
                                             int pSize4, float LowerLimit, float UpperLimit,
                                             IsUseTime pAnswer)
{
#ifdef __DEBUG__
    ...
    return Tensor<DTYPE>::Random_Uniform(new Shape(pSize0, pSize1, pSize2, pSize3, pSize4),
                                         LowerLimit, UpperLimit, pAnswer);
}

template <typename DTYPE>
Tensor<DTYPE>* Tensor<DTYPE>::Random_Uniform(Shape* pShape, float LowerLimit, float UpperLimit,
                                             IsUseTime pAnswer)
{
#ifdef __DEBUG__
    std::cout << "Tensor<DTYPE>::Random_Uniform" << '\n';
 ...
 *@details pSize 0~4를 매개변수로 받는 Shape를 생성하고, 그 생성된 Shape를 매개변수로 갖고 0으로
 *초기화된 LongArray<DTYPE>를 갖는 텐서를 생성한다.
 *@param pSize0 생성하려는 Tensor의 Shape를 구성하는 Time의 Dimension
 *@param pSize1 생성하려는 Tensor의 Shape를 구성하는 Batch의 Dimension
 *@param pSize2 생성하려는 Tensor의 Shape를 구성하는 Channel의 Dimension
 *param pSize3 생성하려는 Tensor의 Shape를 구성하는 Row의 Dimension
 ...
 */
template <typename DTYPE>
Tensor<DTYPE>* Tensor<DTYPE>::Zeros(int pSize0, int pSize1, int pSize2, int pSize3, int pSize4,
                                    IsUseTime pAnswer)
{
#ifdef __DEBUG__
...
*/
template <typename DTYPE>
Tensor<DTYPE>* Tensor<DTYPE>::Zeros(Shape* pShape, IsUseTime pAnswer)
{
#ifdef __DEBUG__
    std::cout << "Tensor<DTYPE>::Zero()" << '\n';
#endif // __DEBUG__
 ...
 *@details pSize 0~4를 매개변수로 받는 Shape를 생성하고, 그 생성된 Shape를 매개변수로 갖고
 *constant로 초기화된 LongArray<DTYPE>를 갖는 텐서를 생성한다.
 *@param pSize0 생성하려는 Tensor의 Shape를 구성하는 Time의 Dimension
 *@param pSize1 생성하려는 Tensor의 Shape를 구성하는 Batch의 Dimension
 *@param pSize2 생성하려는 Tensor의 Shape를 구성하는 Channel의 Dimension
 *@param pSize3 생성하려는 Tensor의 Shape를 구성하는 Row의 Dimension
 ...
 */
template <typename DTYPE>
Tensor<DTYPE>* Tensor<DTYPE>::Constants(int pSize0, int pSize1, int pSize2, int pSize3, int pSize4,
                                        DTYPE constant, IsUseTime pAnswer)
{
#ifdef __DEBUG__
    std::cout << "Tensor<DTYPE>::Constant()" << '\n';
#endif // __DEBUG__

    return Tensor<DTYPE>::Constants(new Shape(pSize0, pSize1, pSize2, pSize3, pSize4), constant,
                                    pAnswer);
}
 ...
 */
template <typename DTYPE>
Tensor<DTYPE>* Tensor<DTYPE>::Constants(Shape* pShape, DTYPE constant, IsUseTime pAnswer)
{
#ifdef __DEBUG__
    std::cout << "Tensor<DTYPE>::Constant()" << '\n';
#endif // __DEBUG__
...
@details 5차원으로 정의된 Tensor에 대해, pShape와 각 축의 인덱스를 매개변수로 받아 이에 대응되는
LongArray의 원소에 접근하기 위한 인덱스 번호를 계산하여 반환한다.
...
@details 4차원으로 정의된 Tensor에 대해, pShape와 각 축의 인덱스를 매개변수로 받아 이에 대응되는
LongArray의 원소에 접근하기 위한 인덱스 번호를 계산하여 반환한다.
@param pShape 인덱싱하려는 Tensor의 Shape
@param ba 접근하려는 Tensor의 shape의 batch 축의 인덱스 번호
@param ch 접근하려는 Tensor의 shape의 channel 축의 인덱스 번호
...
@details 3차원으로 정의된 Tensor에 대해, pShape와 각 축의 인덱스를 매개변수로 받아 이에 대응되는
LongArray의 원소에 접근하기 위한 인덱스 번호를 계산하여 반환한다.
@param pShape 인덱싱하려는 Tensor의 Shape
@param ch 접근하려는 Tensor의 shape의 channel 축의 인덱스 번호
@param ro 접근하려는 Tensor의 shape의 row 축의 인덱스 번호
...
@details 2차원으로 정의된 Tensor에 대해, pShape와 각 축의 인덱스를 매개변수로 받아 이에 대응되는
LongArray의 원소에 접근하기 위한 인덱스 번호를 계산하여 반환한다.
@param pShape 인덱싱하려는 Tensor의 Shape
@param ro 접근하려는 Tensor의 shape의 row 축의 인덱스 번호
@param co 접근하려는 Tensor의 shape의 column 축의 인덱스 번호
@return LongArray 원소에 접근하기 위한 인덱스 번호
*/
inline unsigned int Index2D(Shape* pShape, int ro, int co) { return ro * (*pShape)[1] + co; }
